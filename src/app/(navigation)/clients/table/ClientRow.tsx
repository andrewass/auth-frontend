...
import type { ClientSimple } from "@/app/(navigation)/clients/types";
		...
		<tr key={client.clientId}>
			...
			<td>
				<div className="flex items-center">
					<span className="w-72">
						{hideSecret ? hiddenSecret : client.clientSecret}
					</span>
					<Image
						className="m-3"
						src={hideSecret ? "/enableVisible.svg" : "/disableVisible.svg"}
